...
// Components
import { BaseButton, InvoiceTemplate1, InvoiceTemplate2 } from '@/app/components'

// Template images
import template1 from '@/public/img/invoice-1-example.png'
      ...
      <div>
        ...
        <div>
          <Card>
            <CardHeader>
              Templates
              <CardDescription>Select one of the predefined templates</CardDescription>
            </CardHeader>
            <CardContent className=''>
              <div className='flex overflow-x-auto'>
                {templates.map((template, idx) => (
                  <div key={idx} className='flex flex-col flex-shrink-0 mr-4 gap-y-3'>
                    <p>{template.name}</p>
                    ...
                    <BaseButton onClick={() => setValue('details.pdfTemplate', template.id)}>Select</BaseButton>
                  </div>
                ))}
              </div>
            </CardContent>
