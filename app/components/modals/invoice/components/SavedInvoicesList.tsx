        ...
        {savedInvoices.map((invoice, idx) => (
          ...
          >
            <CardContent className='flex justify-between'>
              <div>
                {/* <FileText /> */}
                <p className='font-semibold'>Invoice #{invoice.details.invoiceNumber} </p>
                <small className='text-gray-500'>Updated at: {invoice.details.updatedAt}</small>
              ...
              <div className='flex flex-col gap-2'>
                <BaseButton tooltipLabel='Load invoice details into the form' variant='outline' size='sm' onClick={() => load(invoice)}>
                  Load
                </BaseButton>

                <BaseButton tooltipLabel='Load invoice and generate PDF' variant='outline' size='sm' onClick={() => loadAndGeneratePdf(invoice)}>
                  Load & Generate
                </BaseButton>
