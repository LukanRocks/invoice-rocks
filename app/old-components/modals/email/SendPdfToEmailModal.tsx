...
const SendPdfToEmailModal = ({ sendPdfToMail, children }: SendPdfToEmailModalProps) => {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className='sm:max-w-[425px]'>
        <DialogHeader>
          ...
          <DialogDescription>Please specify the email address for invoice delivery.</DialogDescription>
        </DialogHeader>
        <Label>Email</Label>
        ...
        <BaseButton tooltipLabel='Send invoice PDF' loading={loading} loadingText='Sending email' onClick={handleSendPdf}>
          Send PDF
        </BaseButton>
      </DialogContent>
    </Dialog>
