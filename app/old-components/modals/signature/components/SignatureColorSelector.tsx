...
// Types
import { SignatureColor } from '@/old-stuff/old-lib/types'
...
const SignatureColorSelector = ({ colors, selectedColor, handleColorButtonClick }: SignatureColorSelectorProps) => {
  return (
