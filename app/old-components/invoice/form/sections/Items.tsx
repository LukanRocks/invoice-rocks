...
// DnD
import { DndContext, closestCenter, MouseSensor, TouchSensor, useSensor, useSensors, DragEndEvent, DragOverlay, UniqueIdentifier } from '@dnd-kit/core'
...
const Items = () => {
  ...
  return (
    <section className='flex flex-col gap-2 w-full'>
      ...
      <BaseButton tooltipLabel='Add a new item to the list' onClick={addNewField}>
        <Plus />
