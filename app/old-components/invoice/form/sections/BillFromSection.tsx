...
const BillFromSection = () => {
  ...
  return (
    <section className='flex flex-col gap-3'>
      ...
      <FormInput name='sender.phone' label={_t('form.steps.fromAndTo.phone')} placeholder='Your phone number' />
      ...
      <BaseButton tooltipLabel='Add custom input to sender' size='sm' variant='link' className='w-fit' onClick={addNewCustomInput}>
        <Plus />
