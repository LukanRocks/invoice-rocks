        ...
        <div className='flex flex-col justify-center px-5 gap-y-3'>
          ...
          <div className='flex justify-between items-center'>
            ...
            <div className=''>
              ...
              <small className='text-sm font-medium text-destructive'>{errors.details?.totalAmount?.message}</small>
            </div>
          </div>

          <div className='flex justify-between items-center'>
            <p>{_t('form.steps.summary.includeTotalInWords')}</p> <p>{totalInWordsSwitch ? _t('form.steps.summary.yes') : _t('form.steps.summary.no')}</p>
            <Switch
