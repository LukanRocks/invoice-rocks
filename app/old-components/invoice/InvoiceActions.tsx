      ...
      <Card className='h-auto sticky top-0 px-2'>
        ...
        <div className='flex flex-col flex-wrap items-center gap-2'>
          <div className='flex flex-wrap gap-3'>
            {/* Load modal button */}
            <InvoiceLoaderModal>
              <BaseButton variant='outline' tooltipLabel='Open load invoice menu' disabled={invoicePdfLoading}>
                <FolderUp />
          ...
          <div className='flex flex-wrap gap-3'>
            {/* New invoice button */}
            <NewInvoiceAlert>
              <BaseButton variant='outline' tooltipLabel='Get a new invoice form' disabled={invoicePdfLoading}>
                <Plus />
            ...
            {/* Generate pdf button */}
            <BaseButton type='submit' tooltipLabel='Generate your invoice' loading={invoicePdfLoading} loadingText='Generating your invoice'>
              <FileInput />
