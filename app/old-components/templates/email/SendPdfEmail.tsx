        ...
        <Body className='bg-gray-100'>
          <Container>
            <Section className='bg-white border-black-950 my-10 px-10 py-4 rounded-md'>
              ...
              <Heading className='leading-tight'>Thanks for using Invoify!</Heading>

              <Text>
                We're pleased to inform you that your invoice <b>#{invoiceNumber}</b> is ready for download. Please find the attached PDF document.
              </Text>
