...
import React, { MutableRefObject, createContext, useCallback, useContext, useMemo, useRef, useState } from 'react'
...
// Variables
import { SIGNATURE_COLORS, SIGNATURE_FONTS } from '@/old-stuff/old-lib/variables'
...
export const SignatureContextProvider = ({ children }: SignatureContextProviderProps) => {
  // Form context
  ...
  const [selectedFont, setSelectedFont] = useState<SignatureFont>(typedSignatureFonts[0])
   ...
   */
  const typedSignatureFontSize = useMemo(() => calculateFontSize(typedSignature), [typedSignature])
