...
const fieldValidators = {
  name: z.string().min(2, { message: 'Must be at least 2 characters' }).max(50, { message: 'Must be at most 50 characters' }),
  address: z.string().min(2, { message: 'Must be at least 2 characters' }).max(70, { message: 'Must be between 2 and 70 characters' }),
  zipCode: z.string().min(2, { message: 'Must be between 2 and 20 characters' }).max(20, { message: 'Must be between 2 and 20 characters' }),
  city: z.string().min(1, { message: 'Must be between 1 and 50 characters' }).max(50, { message: 'Must be between 1 and 50 characters' }),
  country: z.string().min(1, { message: 'Must be between 1 and 70 characters' }).max(70, { message: 'Must be between 1 and 70 characters' }),
  email: z
    .string()
  ...
  // Items
  quantity: z.coerce.number().min(1, { message: 'Must be a number greater than 0' }),
  unitPrice: z.coerce.number().min(1, { message: 'Must be a number greater than 0' }),
